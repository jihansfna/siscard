<x-app-layout>
    <x-slot name="title">Add Master Employee</x-slot>
    ...
    <div class="max-w-3xl mx-auto">
        ...
        <section class="bg-white border border-blue-100 rounded-2xl p-6 shadow-sm">
            ...
            <form action="{{ route('dashboard.employees.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2 group">
                        ...
                        <input id="birth_place" name="birth_place" type="text" value="{{ old('birth_place') }}" placeholder="Tempat Lahir" 
                            class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent focus:bg-white transition-all text-sm">
                    </div>
                ...
                <div class="space-y-2 group">
                    ...
                    <textarea id="address" name="address" rows="3" placeholder="Alamat Lengkap" 
                        class="w-full px-4 py-3 bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent focus:bg-white transition-all text-sm">{{ old('address') }}</textarea>
                </div>
